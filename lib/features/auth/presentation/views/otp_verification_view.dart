                            ...
                            children: [
                              ...
                              WidgetSpan(
                                ...
                                child: GestureDetector(
                                  ...
                                  onTap: () {
                                    // Simply close the OTP modal to return to the Register screen
                                    if (Navigator.of(context).canPop()) {
                                      Navigator.pop(context);
                                    }

                                    // 2. Re-open the Register modal
                                    // It will automatically load the saved data from the RegisterViewModel
                                    RegisterView.show(
                                      context,
                                      email: widget.email,
                                    );
