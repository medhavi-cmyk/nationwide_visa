...
void main() {
  ...
  testWidgets('Authentication Flow - Google Bypass to Profile Setup', (
    WidgetTester tester,
  ) async {
    // Start the app
    app.main();
    ...
    find.text('I already have an account, '); // The RichText span
    ...
    final countryField = find.widgetWithText(
      TextFormField,
      'Country you live in',
    );
    ...
    // Study Country
    final studyCountryField = find.widgetWithText(
      TextFormField,
    ...
    // 5. Profile Setup
    expect(
      find.text("Let's guide you like we did\nour 85K+ students."),
      findsOneWidget,
    );
